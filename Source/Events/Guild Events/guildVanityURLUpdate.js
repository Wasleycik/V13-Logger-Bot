...
module.exports = async (guild, oldVanityURL, newVanityURL) => {
  ...
  var embed = new MessageEmbed()
    ...
    .setDescription(`Sunucu Özel URL Değiştirildi \`${oldVanityURL}\``)
    .setColor(guild.me.displayHexColor)
    .addField(`Üye`, `${guildLog.executor} \`(${guildLog.executor.id})\``)
    .addField(`Özel URL`, `Eski: ${oldVanityURL} Yeni: ${newVanityURL}`)
    .addField(
      `Özel URL Değiştirildiği Zaman`,
